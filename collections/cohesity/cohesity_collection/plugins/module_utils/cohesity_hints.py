...
try:
    ...
    from ansible_collections.cohesity.cohesity_collection.plugins.module_utils.cohesity_auth import Authentication, TokenException, ParameterViolation
    ...
    from ansible.module_utils.cohesity_auth import Authentication, TokenException, ParameterViolation
    from ansible.module_utils.cohesity_utilities import cohesity_common_argument_spec
