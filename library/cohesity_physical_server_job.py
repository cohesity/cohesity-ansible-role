...
def get_physical_server_job_details(module):
    '''
...
def get_physical_server_parent_id(module):
    '''
    :param module: object that holds parameters passed to the module
    :return:
    '''
    try:
        sources = cohesity_client.protection_sources.list_protection_sources_root_nodes(environments='kPhysical')
...
def get_physical_server_source_ids(module):
    '''
    :param module: object that holds parameters passed to the module
    :return:
    '''
    try:
        ...
        protection_sources = cohesity_client.protection_sources.\
            list_protection_sources_registration_info(environments='kPhysical')
...
def start_physical_server_job(module, job_id):
    '''
    :param module: object that holds parameters passed to the module
    :param job_id: protection job id
    :return:
...
def stop_physical_server_job(module, job_id):
    '''
    :param module: object that holds parameters passed to the module
    :param job_id: protection job id
    :return:
...
def create_physical_server_job(module):
    '''
    :param module: object that holds parameters passed to the module
    :return:
    '''
    try:
        ...
        request_body.parent_source_id =\
            get_physical_server_parent_id(module)
        request_body.source_ids = get_physical_server_source_ids(module)
        request_body.environment = 'kPhysical'
...
def delete_physical_server_job(module, job_id):
    '''
    :param module: object that holds parameters passed to the module
    :param job_id: protection job id
    :return:
...
def main():
    ...
    job_details = get_physical_server_job_details(module)
    ...
    if module.check_mode:
        ...
        if job_details:
            delete_physical_server_job(module, job_details.id)
            results = dict(
                changed=True,
        ...
        if job_details:
            start_physical_server_job(module, job_details.id)
        else:
            results = dict(
                changed=False,
                msg="The Cohesity protection job doesn't exist on the cluster"
        ...
        if job_details:
            stop_physical_server_job(module, job_details.id)
        else:
            results = dict(
                changed=False,
                msg="The Cohesity protection job doesn't exist on the cluster"
