...
short_description: Management of Cohesity Protection Policies
description:
    - Ansible Module used to Create, Modify or Delete the Cohesity Protection Policy from a Cluster.
version_added: '2.6.5'
author:
...
options:
  ...
  state:
    description:
      - Determines if the Protection Policy should be present or absent from the host
  ...
  days_to_retain:
    description:
      - Retains backup or 'days_to_retain' number of days
    type: int
    default: 90
  incremental_backup_schedule:
    description:
      - Specify the incremental backup schedule in Protection Policy
    type: dict
  ...
  blackout_window:
    description:
      - Specify the blackout window for retries
    type: list
  retries:
    description:
      - Specify the retry value for retries
    type: int
    default: 3
  retry_interval:
    description:
      - Specify the retry_interval value for retries
    type: int
    default: 30
  bmr_backup_schedule:
    description:
      - Specify the BMR backup schedule for the Protection Policy
    type: dict
  log_backup_schedule:
    description:
      - Specify the Log Backup for the Protection Policy
    type: dict
  extended_retention:
    description:
      - Specify the Extended schedule for the Protection Policy
    type: dict
  archival_copy:
    description:
      - Specify the Archival details for the Protection Policy
    type: dict
requirements: []
'''
