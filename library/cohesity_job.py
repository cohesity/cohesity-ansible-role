...
description:
    - This module will create and destroy Cohesity Protection Jobs for the selected Protection Sources.
version_added: '2.6.5'
author:
...
def verify__job_status__details(module, self, job_runs=[], state='start'):
    import time
    loop_cnt = 0
    while loop_cnt <= 20:
        payload = self.copy()
...
def start_job(module, self):
    ...
    try:
        ...
        verify__job_status__details(module, self, [self['id']], state='start')
    ...
    if module.check_mode:
        ...
        if module.params.get('state') == "present":
            ...
            if job_exists:
                ...
                heck_mode_results['id'] = job_exists
            else:
                check_mode_results[
